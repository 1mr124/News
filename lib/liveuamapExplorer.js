...
(function (root, factory) {
  ...
  function urlFor(country) {
    return "https://" + country.slug + ".liveuamap.com/";
  }
  ...
  function init(mountEl) {
    ...
    var bar = el("div", { class: "lu-bar" }, [currentLabel, el("span", { class: "lu-bar-spacer" }), pinBtn, resetBtn, openBtn]);
      ...
      if (reason !== "unsupported") {
        kids.push(el("div", { class: "lu-fallback-actions" }, [
          el("button", {
            ...
            onclick: function () { window.open(urlFor(country), "_blank", "noopener,noreferrer"); },
          }),
          el("button", {
            class: "hdrbtn",
            type: "button",
    ...
    openBtn.addEventListener("click", function () {
      if (current && current.verified === true) window.open(urlFor(current), "_blank", "noopener,noreferrer");
    });
